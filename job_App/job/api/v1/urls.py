...
from .views import job_list, job_details, job_create, job_edit, job_delete, accept_developer, apply_job, finish_job
...
urlpatterns = [
    ...
    path('<int:id>/finish', finish_job, name='finish_job'),
]